 ...
 * @Description: TODO
 * @Author Li_jiaMeng
 * @Date Created in 13:52 2020/12/21
 *
 * 需求：
 * 1.从 Activiti 的 act_ge_bytearray表中读取两个资源文件
 * 2.将两个资源文件保存到路径：
 *
 * 技术方案：
...
public class QueryBpmnFile {
    ...
    public static void main(String[] args) throws IOException {
        ...
        processDefinitionQuery.processDefinitionId("holiday:1:20004");
        ...
        //8.构建出OutputStream流
        OutputStream pngOs =
                new FileOutputStream("F:\\" + processDefinition.getDiagramResourceName());

        OutputStream bpmnOs =
                new FileOutputStream("F:\\" + processDefinition.getResourceName());
